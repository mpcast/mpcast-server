...
/**
 * View adapter config
 * @type {{type: string, common: {viewPath: *, sep: string, extname: string}, nunjucks: {handle: Nunjucks, options: {tags: {variableStart: string, variableEnd: string}}, beforeRender: module.exports.nunjucks.beforeRender}}}
 */
module.exports = {
  type: 'nunjucks',
  common: {
