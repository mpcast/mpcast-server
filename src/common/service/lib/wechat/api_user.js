...
exports.getUserFromMinapp = async (options) => {
...
exports.getUser = async function (options) {
  ...
  const url = this.prefix + 'user/info?openid=' + options.openid + '&lang=' + options.lang + '&access_token=' + accessToken;
...
exports.batchGetUsers = async function (openids, lang = 'zh_CN') {
  const { accessToken } = await this.ensureAccessToken();
  const url = this.prefix + 'user/info/batchget?access_token=' + accessToken;
  const data = {};
...
exports.getFollowers = async function (nextOpenid) {
  ...
  const url = this.prefix + 'user/get?next_openid=' + nextOpenid + '&access_token=' + accessToken;
  return this.request(url, {dataType: 'json'});
};
...
exports.updateRemark = async function (openid, remark) {
  ...
  const url = this.prefix + 'user/info/updateremark?access_token=' + accessToken;
  const data = {
    openid: openid,
    remark: remark
  };
...
exports.createTags = async function (name) {
  ...
  const url = this.prefix + 'tags/create?access_token=' + accessToken;
  const data = {
    tag: {
      name: name
    }
...
exports.getTags = async function () {
  ...
  const url = this.prefix + 'tags/get?access_token=' + accessToken;
...
exports.updateTag = async function (id, name) {
  ...
  const url = this.prefix + 'tags/update?access_token=' + accessToken;
  const data = {
    tag: {
      id: id,
      name: name
...
exports.deleteTag = async function (id) {
  ...
  const url = this.prefix + 'tags/delete?access_token=' + accessToken;
  const data = {
    tag: {
      id: id
    }
...
exports.getUsersFromTag = async function (tagId, nextOpenId) {
  ...
  const url = this.prefix + 'user/tag/get?access_token=' + accessToken;
  const data = {
    tagid: tagId,
...
exports.batchTagging = async function (openIdList, tagId) {
  ...
  const url = this.prefix + 'tags/members/batchtagging?access_token=' + accessToken;
  const data = {
...
exports.batchUnTagging = async function (openIdList, tagId) {
  ...
  const url = this.prefix + 'tags/members/batchuntagging?access_token=' + accessToken;
  const data = {
    openid_list: openIdList || [],
    tagid: tagId
  };
...
exports.getIdList = async function (openId) {
  ...
  const url = this.prefix + 'tags/getidlist?access_token=' + accessToken;
  const data = {
    openid: openId
  };
  return this.request(url, postJSON(data));
